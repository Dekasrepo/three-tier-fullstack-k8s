...
3. Update Kubernetes Manifests (update with your wn images from your docker repository)
...
# Update k8s/04-tls-secret.yaml with these values
# Then deploy
